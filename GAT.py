...
class SimpleGAT(nn.Module):
    def __init__(self, input_dim, hidden_dim=128):
        ...
        self.linear = nn.Linear(hidden_dim * 4, 1)
...
model = SimpleGAT(input_dim).to(device)
...
results_df.to_csv('gat_vfe_predictions.csv', index=False)
print("Saved predictions to 'gat_vfe_predictions.csv'.")
...
plt.title('GAT: Actual vs Predicted Vacancy Formation Energy')
plt.grid(True)
plt.tight_layout()
plt.show()
